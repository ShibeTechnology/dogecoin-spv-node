...
test('successfully decode `block` payload', t => {
  ...
  const result = decodeBlockMessage(Buffer.from(data.hex, 'hex'))
...
test('successfully encode `filterload` payload', t => {
  ...
  const result = encodeFilterLoad(data.value)
...
test('successfully encode `getblocks` payload', t => {
  ...
  const result = encodeGetblocksMessage(data.value.blockHash, data.value.lastHash)
...
test('successfully encode `getheaders` payload', t => {
  ...
  const result = encodeGetheadersMessage(data.value.blockHash)
...
test('successfully decode `headers` payload', t => {
  ...
  const result = decodeHeadersMessage(Buffer.from(data.hex, 'hex'))
...
test('successfully decode `inv` payload', t => {
  ...
  const result = decodeInvMessage(Buffer.from(data.hex, 'hex'))
...
test('successfully decode `merkleblock` payload', t => {
  ...
  const result = decodeMerkleblockMessage(Buffer.from(data.hex, 'hex'))
...
test('successfully encode `ping` payload', t => {
  ...
  const result = encodePingMessage(BigInt(data.value))
...
test('successfully decode `reject` payload', t => {
  ...
  const result = decodeRejectMessage(Buffer.from(data.hex, 'hex'))
...
test('successfully decode `tx` payload', t => {
  ...
  // and buffer
  for (const i in data.value.txOuts) {
  ...
  const result = decodeTxMessage(Buffer.from(data.hex, 'hex'))
...
test('successfully encode `version` payload', t => {
  ...
  const result = encodeVersionMessage(data.value)
...
test('successfully decode `version` payload', t => {
  ...
  const result = decodeVersionMessage(Buffer.from(data.hex, 'hex'))
...
test('successfully decode `addr` payload', t => {
  ...
  const result = decodeAddrMessage(Buffer.from(data.hex, 'hex'))
...
test('successfully encode packet', t => {
  ...
  const result = preparePacket(data.value.cmd, Buffer.from(data.value.payload, 'hex'), TESTNET_MAGIC_BYTES)
...
test('successfully decode packet', t => {
  ...
  const result = decodePacket(Buffer.from(data.hex, 'hex'), TESTNET_MAGIC_BYTES)
